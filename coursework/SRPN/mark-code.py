...
while place <= 5:
  ...
  diff = os.system("FC test.txt t-single/0" + str(place) + ".result.term > temp.txt")
  if diff == 0:
    tsingle+=1
    marks+=1
    print("Test passed")
...
while place <= 5:
  ...
  diff = os.system("FC test.txt t-multiple/0" + str(place) + ".result.term > temp.txt")
  if diff == 0:
    tmultiple+=1;
    marks+=1
    print("Test passed")
...
while place <= 5:
  ...
  diff = os.system("FC test.txt t-saturation/0" + str(place) + ".result.term > temp.txt")
  if diff == 0:
    tsaturation+=1
    marks+=1
    print("Test passed")
...
while place <= 5:
  ...
  diff = os.system("FC test.txt t-obscure/0" + str(place) + ".result.term > temp.txt")
  if diff == 0:
    tobscure+=1;
    marks+=1
    print("Test passed")
